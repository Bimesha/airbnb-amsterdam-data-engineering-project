...
The following items were not completed because they were outside the selected scope or not possible with the available data.

| Area | Status | Reason |
|---|---|---|
| Cross-city comparison | Not completed | The project focused on Amsterdam only to keep the scope realistic. |
| Weekday vs weekend price analysis | Not completed | Calendar price and adjusted price fields were missing. |
